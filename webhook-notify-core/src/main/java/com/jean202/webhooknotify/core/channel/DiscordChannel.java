...
public final class DiscordChannel implements NotifyChannel {
     ...
     */
    public DiscordChannel(String webhookUrl, HttpClient httpClient, Duration requestTimeout) {
    ...
    public void send(NotifyMessage message) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Timed out sending Discord notification after " + requestTimeout, exception
            );
